...
# address the RDT issue with pycurl
...
print("hydrodata: %s, %s" % (hydrodata.__version__, hydrodata.__file__))
...
project = "hydrodata"
copyright = "2019-%s, Taher Chegini" % datetime.datetime.now().year
...
version = hydrodata.__version__.split("+")[0]
# The full version, including alpha/beta/rc tags.
release = hydrodata.__version__
...
texinfo_documents = [
    (
        ...
        "hydrodata Developers",
        "hydrodata",
        "Portal to hydrology and climatology data in Python.",
        "Miscellaneous",
    )
]
